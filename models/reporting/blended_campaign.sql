...
-- Macro to generate posthog data by granularity
...
posthog_consults_data AS (
    {{ posthog_granular('reporting.bariendo_posthog_consults_performance', 'last_payment_date', 'posthog_consults') }}
),

posthog_signups_data AS (
    {{ posthog_granular('reporting.bariendo_posthog_signups_performance', 'first_signup_date', 'posthog_signups') }}
),
