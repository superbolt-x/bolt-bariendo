...
LEFT JOIN 
    (SELECT 'day' as date_granularity,
        ...
        COALESCE(SUM(CASE WHEN conversion_action_name ~* 'signup' THEN conversions END),0) as signups,
        COALESCE(SUM(CASE WHEN conversion_action_name ~* 'Consultation Payment' THEN conversions END),0) as consultation_payment
